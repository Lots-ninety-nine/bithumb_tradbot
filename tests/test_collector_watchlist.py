...
class _FakeExchange:
    ...
    def get_top_volume_tickers(self, limit: int = 10, quote: str = "KRW"):
        return ["KRW-BTC", "KRW-ETH", "KRW-XRP"][:limit]
...
class CollectorWatchlistTest(unittest.TestCase):
    def test_refresh_watchlist_merges_top_and_extra(self) -> None:
        collector = MarketDataCollector(
            ...
            top_n=3,
            max_watchlist=5,
            extra_watchlist=("KRW-SOL", "ada", "KRW-XRP"),
        )
        watchlist = collector.refresh_watchlist()
        self.assertEqual(watchlist, ["KRW-BTC", "KRW-ETH", "KRW-XRP", "KRW-SOL", "KRW-ADA"])
